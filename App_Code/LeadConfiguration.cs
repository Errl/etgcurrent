...
/// <summary>
/// Summary description for LeadConfiguration
/// </summary>
public  static class LeadConfiguration
{
    ...
    static LeadConfiguration()
    {
        dbConnectionString = ConfigurationManager.ConnectionStrings["LeadsConnectionString"].ConnectionString;
        dbProviderName = ConfigurationManager.ConnectionStrings["LeadsConnectionString"].ProviderName;
