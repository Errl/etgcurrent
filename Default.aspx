<%@ Page Title="Airline Miles-Credit Card Points-Business Class Flights"
    MetaDescription="Using miles to Book discounted business first class flights. Corporate airline tickets"
    MetaKeywords="use airline miles, use credit card points, using airline miles for travel, use airline and credit card point to book flights, corporate airline miles"
    Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" src="http://www.24-7pressrelease.com/js/newsfeed.js"></script>
    <script type="text/javascript" src="http://www.24-7pressrelease.com/js/js_press_releases.php?category_id=280&limit=3"></script>
            ...
            <ul>
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
                    ...
                    <div class="tp-caption sfr"
                        ...
                        data-easing="easeOutBack">
                        <a href="Quote.aspx">
                            <img src="images-slider/click.png" alt="Get a Free Business Class flight quote" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <a href="useairlinemiles.aspx" title="using airline miles">
                            <img src="images-slider/etgmc.png" alt="use airline miles on travel" id="luxury" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <a href="businessfirst.aspx" title="use airline miles on flights">
                            <img src="images-slider/etgbf.png" alt="using credit card points on travel" id="Img1" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        data-easing="easeOutBack">
                        <a href="#">
                            <img src="images-slider/Osvaldo.png" alt="Elite Travel Guru did an outstanding job" id="Img2" /></a>
                    </div>
                </li>
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
                    ...
                    <div class="tp-caption sfr"
                        ...
                        <a href="Services.aspx">
                            <img src="images-slider/clickfind.png" alt="submit a request for a free consultation" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <a href="passport.aspx" title="Need a Passport?">
                            <img src="images-slider/passports.png" alt="Need a Passport?" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <a href="passport.aspx" title="Need a Visa?">
                            <img src="images-slider/visas.png" alt="Need a Visa?" /></a>
                    </div>
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <a href="cellular.aspx" title="Rent a cellular phone for your travel">
                            <img src="images-slider/cellphones.png" alt="Rent a cellular phone for your travel" id="Img3" /></a>
                    </div>
                </li>
            </ul>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
 ...
 <img src="images/emailpic.jpg" />         
    ...
    <ul>
        ...
        <li><a href="http://elitetravelguru.com/quote.aspx">Quote</a></li>
     
       
     
        <li><a href="http://elitetravelguru.com/services.aspx">Services</a></li>
     
     
        <li><a href="http://elitetravelguru.com/blogengine/default.aspx">Blog</a></li>
     
        <li><a href="http://elitetravelguru.com/customerreviews.aspx">Testimonials</a></li>

         <li><a href="http://elitetravelguru.com/about.aspx">About</a></li>
        <li><a href="http://elitetravelguru.com/contact.aspx">Contact</a></li>
        <li><a href="http://elitetravelguru.com/privacypolicy.aspx">Privacy Policy</a></li>
    ...
    <div id="content" class="no-bottom" style="padding-top:25px">
        ...
        <div class="container">
            <div class="row" style="text-align:center; padding-bottom:25px">
                <div class="span12">
                    <a href="http://www.gopjn.com/t/SkNHSUZLS0dDR0dLTUpIQ0dGTUdGSw"><img src="http://www.gopjn.com/b/SkNHSUZLS0dDR0dLTUpIQ0dGTUdGSw" border="0" width="728" height="90" title="Earn up to 20,000 airline miles per hotel booking with Rocketmiles." alt="Earn up to 20,000 airline miles per hotel booking with Rocketmiles."></a>
                </div>
            </div>
            <div class="row">
                <div class="span6">
                    <h3>Up to 70% off <a href="businessfirst.aspx" title="discounted international business class flights">business class flights</a>. Free Quote.</h3>
                    Feel free to submit form below to receive a quote.
                        <br />

                    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="MyTabStyle">
                        <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Flight" BackColor="#e4e4e4" CssClass="quote">
                            <ContentTemplate>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="contact_form_holder">
                                        <asp:Panel runat="server" BackColor="#e4e4e4" BorderStyle="none">
                                            <div class="row" style="text-align: center; padding-left: 8px;">
                                                <asp:RadioButtonList ID="newTrip" runat="server" CssClass="formlabel" AutoPostBack="True" RepeatDirection="Horizontal" Width="60%" BorderStyle="None" BorderWidth="0px" BorderColor="#335a96" OnSelectedIndexChanged="newTrip_SelectedIndexChanged">
                                                    ...
                                                    <asp:ListItem Value="2" Selected="True">round-trip</asp:ListItem>
                                            ...
                                            <div class="row">
                                                <div class="span3">
                                                    <label>
                                                        Departure City<span class="req">*  </span>
                                                ...
                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="newDeparture" DelimiterCharacters="" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem"
                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" Enabled="True" ServiceMethod="GetCompletionList" ServicePath="" UseContextKey="true">
                                                </asp:AutoCompleteExtender>

                                                <div class="span2">
                                                    <label>
                                                        Departure Date <span class="req">*  </span>
                                            ...
                                            <div class="row">
                                                <div class="span3">
                                                    ...
                                                    <label>
                                                        Arrival City<span class="req">*  </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="span2">
                                                    ...
                                                    <label>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" BorderStyle="None" ControlToValidate="newPhone" ErrorMessage="Please enter a valid phone number" ForeColor="Red" Display="Dynamic" CssClass="validation">*</asp:RequiredFieldValidator></label>
                                        ...
                                        <asp:Panel runat="server" ID="expedia" Visible="false">
                                            <div id='searchform_635277625540238755'></div>
                                            <script type='text/javascript' src='http://widgets.partners.expedia.com/daily/shared/affiliates/WidgetService.aspx?partner=cj&pid=7405130&size=300x250&window=new&branded=true&widgetname=searchform&divid=searchform_635277625540238755&langid=1033'></script>
                                        </asp:Panel>
                                    </ContentTemplate>
                                    <Triggers>
                        ...
                        <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Hotel" BackColor="#e4e4e4" class="quote">
                            <ContentTemplate>
                                <div class="contact_form_holder" >
                                    ...
                                    <div class="search-widget-inner">
                                        <div class="predefined-destinations-block">
                                            ...
                                            <ul id="predefined-destinations">
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-4fded4ff-af4a-41b7-976b-bd5bd436f135|cities|Las Vegas, Nevada, United States" name="predefined" value="Las Vegas, Nevada, United States" />
                                                    <label for="AREA-4fded4ff-af4a-41b7-976b-bd5bd436f135|cities|Las Vegas, Nevada, United States">Las Vegas</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-4ff23c22-e4ff-4834-91bd-08bad605fe8c|cities|Orlando, Florida, United States" name="predefined" value="Orlando, Florida, United States" />
                                                    <label for="AREA-4ff23c22-e4ff-4834-91bd-08bad605fe8c|cities|Orlando, Florida, United States">Orlando</label>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-0a76bcac-47c9-49d9-8f2d-b164a6e568d4|cities|Chicago, Illinois, United States" name="predefined" value="Chicago, Illinois, United States" />
                                                    <label for="AREA-0a76bcac-47c9-49d9-8f2d-b164a6e568d4|cities|Chicago, Illinois, United States">Chicago</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-06f7ecb1-77eb-45a4-bbc4-aec1efb7b3c6|cities|Atlanta, Georgia, United States" name="predefined" value="Atlanta, Georgia, United States" />
                                                    <label for="AREA-06f7ecb1-77eb-45a4-bbc4-aec1efb7b3c6|cities|Atlanta, Georgia, United States">Atlanta</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-3d931ace-e3fe-46b4-a243-61d44a22053b|cities|London, United Kingdom" name="predefined" value="London, United Kingdom" />
                                                    <label for="AREA-3d931ace-e3fe-46b4-a243-61d44a22053b|cities|London, United Kingdom">London</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-9c816970-833e-4953-9bc2-9769e5c7d1ad|cities|San Diego, California, United States" name="predefined" value="San Diego, California, United States" />
                                                    <label for="AREA-9c816970-833e-4953-9bc2-9769e5c7d1ad|cities|San Diego, California, United States">San Diego</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-8d4456fb-4038-4a55-bcbe-aa544ab549ad|cities|San Francisco, California, United States" name="predefined" value="San Francisco, California, United States" />
                                                    <label for="AREA-8d4456fb-4038-4a55-bcbe-aa544ab549ad|cities|San Francisco, California, United States">San Francisco</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-a2afb563-0907-4a03-86f0-03006aed6e0e|cities|Boston, Massachusetts, United States" name="predefined" value="Boston, Massachusetts, United States" />
                                                    <label for="AREA-a2afb563-0907-4a03-86f0-03006aed6e0e|cities|Boston, Massachusetts, United States">Boston</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-b092733b-991a-47b1-8f10-46ea10fa8e00|cities|Los Angeles, California, United States" name="predefined" value="Los Angeles, California, United States" />
                                                    <label for="AREA-b092733b-991a-47b1-8f10-46ea10fa8e00|cities|Los Angeles, California, United States">Los Angeles</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-24714305-67fd-42f7-83f1-672fc0071b2c|cities|New Orleans, Louisiana, United States" name="predefined" value="New Orleans, Louisiana, United States" />
                                                    <label for="AREA-24714305-67fd-42f7-83f1-672fc0071b2c|cities|New Orleans, Louisiana, United States">New Orleans</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="AREA-2c89971e-5b17-42a9-8ac2-7a7108aba022|cities|Washington, DC, United States (Washington D.C.)" name="predefined" value="Washington, DC, United States (Washington D.C.)" />
                                                    <label for="AREA-2c89971e-5b17-42a9-8ac2-7a7108aba022|cities|Washington, DC, United States (Washington D.C.)">Washington</label>
                                                </li>
                                            </ul>
                                        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <script src="https://www.travelnow.com/templates/454238/static/17/default/js/yui2/yuiloader/yuiloader-min.js"><!-- --></script>

                                <!-- Loads the calendar locale. -->
                                <script src="https://www.travelnow.com/templates/454238/static/17/default/js/locales/locale_en.js"><!-- --></script>
                                ...
                                <script type="text/javascript">
                                    ...
                                    var SearchWidget = {
                                        ...
                                        decorateSearch: function () {
                                            ...
                                            self.YAHOO.util.Event.on(self.YAHOO.util.Dom.get(self.SEARCH_ID), "click", function () {
                                                ...
                                                var url = "https://www.travelnow.com/templates/454238/searchWidget?autosearch=true";
                                    ...
                                    var searchWidgetYahooUIloader = new YAHOO.util.YUILoader({
                                        ...
                                        base: 'https://www.travelnow.com/templates/454238/static/17/default/js/yui2/'
                ...
                <div class="span6">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                            ...
                            <h3>Get a free <a href="useairlinemiles.aspx" title="use airline miles">Airline Miles</a> Consultation!</h3>
                            Feel free to submit form below to receive a free <a href="useairlinemiles.aspx" title="use airline miles to book flights">Airline Miles</a> or <a href="useairlinemiles.aspx" title="book flights with credit card points">Credit Card Points Evaluation</a>.
                        <asp:ValidationSummary ID="ValidationSummary2" runat="server" ValidationGroup="miles" />
                            <br />
                            <br />
                            <br />
                            
                            <asp:Panel ID="Panel1" runat="server" BackColor="#e4e4e4" CssClass="quote">
                                <div class="contact_form_holder" >
                                <div class="row" style="padding-top: 9px;">
                                    <div class="span3">

                                        <label>
                                            Kind of points<span class="req">*  </span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" BorderStyle="None" ControlToValidate="newKind" ErrorMessage="Please enter a valid email" ForeColor="Red" Display="Dynamic" CssClass="validation" ValidationGroup="miles">*</asp:RequiredFieldValidator></label>
                                        <asp:TextBox ID="newKind" CssClass="full quote" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="span2">

                                        <label>
                                            Amount<span class="req">*  </span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" BorderStyle="None" ControlToValidate="newAmount" ErrorMessage="Please enter your name" ForeColor="Red" Display="Dynamic" CssClass="validation" ValidationGroup="miles">*</asp:RequiredFieldValidator></label>
                                        <asp:TextBox ID="newAmount" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="span3">

                                        <label>Kind of points</label>
                                        <asp:TextBox ID="newKind2" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="span2">

                                        <label>Amount</label>
                                        <asp:TextBox ID="newAmount2" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="span5">
                                        ...
                                        <asp:TextBox ID="newMessage" runat="server" TextMode="MultiLine" Columns="7" Rows="4" CssClass="full"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="span2">
                                        ...
                                        <label>
                                            Email<span class="req">* </span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" BorderStyle="None" ControlToValidate="newEMailMiles" ErrorMessage="Please enter a valid email" ForeColor="Red" Display="Dynamic" CssClass="validation" ValidationGroup="miles">*</asp:RequiredFieldValidator></label>
                                        <asp:TextBox ID="newEmailMiles" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="span1">

                                        <label>
                                            Name<span class="req">*  </span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" BorderStyle="None" ControlToValidate="newNameMiles" ErrorMessage="Please enter your name" ForeColor="Red" Display="Dynamic" CssClass="validation" ValidationGroup="miles">*</asp:RequiredFieldValidator></label>
                                        <asp:TextBox ID="newNameMiles" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="span2">

                                        <label>
                                            Phone<span class="req">*  </span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" BorderStyle="None" ControlToValidate="newPhoneMiles" ErrorMessage="Please enter a valid phone number" ForeColor="Red" Display="Dynamic" CssClass="validation" ValidationGroup="miles">*</asp:RequiredFieldValidator></label>
                                        <asp:TextBox ID="newPhoneMiles" CssClass="full" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="span2">
                                        <p id="P1">
                                            ...
                                            <asp:ImageButton ID="ImageButton2" CausesValidation="true" ValidationGroup="miles" runat="server" ImageUrl="~/images/btnsubmit.png" OnClick="ImageButton2_Click" />
                                        </p>
                                    </div>
                                </div>
                                <div class="span3"></div>
            ...
            <div class="row">
                <div class="flexslider logo-carousel no-control">
                    <ul class="slides">
                        <li>
                            <div class="span2">
                                <img src="images/logo/Alitalia.png" alt="Al Italia Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/AF.png" alt="Air France Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/ANA-Logo.png" alt="All Nippon Airways Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/IBERIA.png" alt="Iberia Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/Korean.png" alt="Korean Air Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/Lufthansa_Logo.png" alt="Lufthansa Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/Thai_Logo.png" alt="Thai Airways Businesss Class Flights" />
                            </div>
                        </li>

                        <li>
                            <div class="span2">
                                <img src="images/logo/virginatlantic.png" alt="Virgin Atlantic Businesss Class Flights" />
                            </div>
                        </li>
                    </ul>
                </div>
