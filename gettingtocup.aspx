<%@ Page Title="Getting World Cup Brazil 2014"
    ...
    airline reward business trips, maximizing airline rewards, corporate group travel, discounted business travel, cheap luxury corprorate travel"
     Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="gettingtocup.aspx.cs" Inherits="gettingtocup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="content">
        <div class="container">
            <div class="row">
                <div class="span12">
                    <h1>Getting to Brazil</h1>
                    <span>News & info on getting to the cup</span><img style="padding-right:10px" src="images/flybrazilsm.png" />                    
                    <ul class="crumb">
            ...
            <div class="container">
                <div class="row">
                    <div class="span7">
                        <img class="img-rounded" style="margin-bottom:15px;" src="images/flybrazilstadium.png" />
                        <img class="img-rounded" style="margin-bottom:15px;" src="images/flybrazilmap.png" />
                        <img class="img-rounded" style="margin-bottom:15px;" src="images/flybrazilsuitcase.png" />
                    </div>
...
<!--
    rssmikle_url = "http://www.theguardian.com/football/2013/oct/16/world-cup-2014-travel-all-need-to-know/rss";
