<%@ Page Title=" World Cup Brazil 2014 Standings"
    MetaDescription="2014 Brazil World Cup brackets"
    ...
    airline reward business trips, maximizing airline rewards, corporate group travel, discounted business travel, cheap luxury corprorate travel" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="worldcupstandings.aspx.cs" Inherits="worldcupstandings" %>
         ...
         <div class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <span>Standings & Tables for World Cup 2014</span><img style="padding-right:10px" src="images/flybrazilsm.png" />                    
                    <ul class="crumb">
            ...
            <div class="container">
                <div class="row">
                    <div class="span9">
                        <iframe src="http://www.tablesleague.com/iframe_page/?id=5df8b7fc194c44e4e8bfb68e866652c4" width="800" height="1200" frameborder="0" scrolling="yes"></iframe>
                    </div>
                    <div id="sidebar" class="span3">
                        <!-- start feedwind code -->
<script type="text/javascript">
<!--
    rssmikle_url = "http://feeds.bbci.co.uk/sport/0/football/rss.xml?edition=int";
    rssmikle_frame_width = "270";
